...
class  ExampleUnitTest {
    ...
    fun levelUpFormulaTest() {
        val charmander = ChimeraFactory.createChimera(ChimeraSpecies.Charmander)
    ...
    @Test
    fun accuracyTest() {
        val attacker = ChimeraFactory.createChimera(ChimeraSpecies.Charmander)
        val target = ChimeraFactory.createChimera(ChimeraSpecies.Charmander)
    ...
    fun damageEffectTest() {
        val attacker = ChimeraFactory.createChimera(ChimeraSpecies.Charmander, level = 5)
        val target = ChimeraFactory.createChimera(ChimeraSpecies.Charmander, level = 5)
    ...
    @Test
    fun newMoveTest() {
        val charmander = ChimeraFactory.createChimera(ChimeraSpecies.Charmander, level = 3)
